...
@WebServlet(name = "LoginCookiePost",
        urlPatterns = "/LoginCookiePost")
public class LoginCookiePost extends HttpServlet {
    ...
    protected void sendLogin(HttpServletResponse response, Boolean sucesso) throws IOException {
        ...
        out.println("<form method='post' action='LoginCookiePost'>");
