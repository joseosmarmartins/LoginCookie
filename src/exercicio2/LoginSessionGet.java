...
@WebServlet("/LoginSessionGet")
public class LoginSessionGet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(login(nome,senha)){
            response.sendRedirect("LoginSessionOkGet?user=" + nome + "&pass=" + senha);
        }else{
    ...
    private void sendLoginForm(HttpServletResponse response, boolean withErrorMessage) throws IOException, ServletException {
        ...
        out.println("<form method='post' action='LoginSessionGet'>");
